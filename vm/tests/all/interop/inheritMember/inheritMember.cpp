...
JS_LinearFunction* js_m4p2 = jsFile->invoke("LinearFunction", 4, 2);
JS_ConstFunction* js_c3 = jsFile->invoke("ConstFunction", 5);
Python_LinearFunction* py_m4p2 = pyFile->invoke("LinearFunction", 4, 2);
Python_ConstFunction* py_c3 = pyFile->invoke("ConstFunction", 5);
LLVM_LinearFunction* ll_m4p2 = llvmFile->invoke("LinearFunction", 4, 2);
LLVM_ConstFunction* ll_c3 = llvmFile->invoke("ConstFunction", 5);
